...
#wrapper-foot {  background: rgba($secondary, $opac1); }
...
#ls_cart_widget:hover{  opacity:  $opac6; }
#ls_cart_widget .cart-summary a, #ls_cart_widget .cart-summary, , #ls_cart_widget .cart-summary span { color: $secondary;  font-family: $fonthead; }
...
.dest-list h1, .contact-dates h1 { color: $txt; font-family: $fonthead; border-color: rgba($secondary, $opac2);  }
...
.dest-list h2 { border-bottom: 1px solid; font-size: 16px; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; }
...
#newsletter input[type="news"], #newsletter input[type="text"], #newsletter input[type="email"], .account-form-wrapper input[type="text"], .account-form-wrapper input[type="email"], .account-form-wrapper input[type="password"] { color: $primary; border-color: $primary; background-color: $back; }
input, button, select, textarea {  font-family: $fonttxt; }
#newsletter input.btn, .account-form-wrapper input.btn { background: $primary; color: $back; font-family: $fontbot; }
#newsletter input:hover.btn, .account-form-wrapper input:hover.btn { background: rgba($secondary, $opac6);   }
#wrapper-foot a:hover.soc-foot { background-color: rgba($secondary, $opac4);}


#breadcrumb, #breadcrumb a{ font-family: $fonthead; color:  rgba($secondary, $opac4) }
...
.button#change-quantities:hover, #shipping-calculator-form .button:hover, .button.secondary:hover, .button.secondary i.fa a.secondary:hover, .product-details-overlay.overlay a.top.secondary:hover { color: $back; background: $tertiary !important; }
...
.productContainer .descriptioncol .attributeLine label .number, .productContainer .descriptioncol .attributeLineQuickshop label .number { color: rgba($secondary, $opac8); font-family: $fonttxt; background-color: rgba($secondary, $opac1); }
...
.headerBox-Error p { color: $txt; font-family: $fonttxt; }
...
#checkoutForm .form-field input,.contact_form .field input,.contact_form .field textarea{ border-color: rgba($back, $opac6); font-family: $fonttxt; color: $back; }
