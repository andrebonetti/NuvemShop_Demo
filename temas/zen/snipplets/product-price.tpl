{% set price_html %}
<div class="price" {% if not product.display_price%}style="display:none;"{% endif %}>
    ...
    <span class="price" id="price_display" {% if schema %}itemprop="price"{% endif %} {% if not product.display_price %}style="display:none;"{% endif %}>{{ product.price | money }}</span>
    {% if schema %}
