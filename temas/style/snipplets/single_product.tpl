<a href="{{ product.url }}?variant={{ product.selected_or_first_available_variant.id }}" title="{{ product.name }}" data-path-hover="M 180,400 0,400 0,140 180,160 z" itemscope itemtype="http://schema.org/Product">
