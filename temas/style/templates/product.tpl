        ...
        <div class="row" id="single-product" data-variants="{{product.variants_object | json_encode }}">
            ...
            <div class="col-md-6 description-col">
                <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                    <div class="price-container {% if not product.display_price%}displaynone{% endif %}">
                        <p id="compare_price_display" class="{% if not product.compare_at_price %}displaynone{% endif %} big-old-price"> {{ product.compare_at_price | money }}</p>
                        <p class="big-price {% if not product.display_price %}displaynone{% endif %}" id="price_display" itemprop="price">{{ product.price | money }}</p>
