        ...
        <form id="login-form" action="" method="post" class="form-horizontal">
            ...
            {% if store_fb_app_id %}
                <div class="col-sm-offset-4 col-sm-5 col-xs-12">
                    ...
                    <input class="btn btn-primary btn-lg facebook" type="button" value="{{ 'Regístrate con Facebook' | translate }}" onclick="loginFacebook();" />
                </div>
                <div class="col-sm-offset-4 col-sm-5 c col-xs-12">
                    <span class="badge">{{ 'o' | translate }}</span>
                    <hr class="featurette-or-divider"></hr>
                </div>
            {% endif %}
            <div class="form-group">
                <label class="control-label col-sm-4 col-xs-12" for="name">{{ 'Nombre' | translate }}</label>
                <div class="col-sm-5">
                    <input class="form-control" type="text" name="name" id="name" value="{{ result.name }}" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4 col-xs-12" for="email">{{ 'Email' | translate }}</label>
                <div class="col-sm-5">
                    <input class="form-control" autocorrect="off" autocapitalize="off" type="email" name="email" id="email" value="{{ result.email }}" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4 col-xs-12" for="phone">{{ 'Teléfono' | translate }} {{ '(opcional)' | translate }}</label>
                <div class="col-sm-5">
            ...
            <div class="form-group">
                <label class="control-label col-sm-4 col-xs-12" for="password_confirmation">{{ 'Confirmar Contraseña' | translate }}</label>
                <div class="col-sm-5">
            ...
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-5 col-xs-12">
                    <input class="btn btn-primary btn-lg" type="submit" value="{{ 'Crear cuenta' | translate }}" />
                </div>
            </div>
        </form>
    </div>
