                ...
                <div class="row vista_producto">
                        ...
                        <div class="cloud-zoom-wrap">
                            {% if product.featured_image %}
                                <a href="{{ product.featured_image | product_image_url('original') }}" id="zoom"
                                        {% if product.images_count > 1 %} class="cloud-zoom" {% endif %}
                    ...
                    <div class="info_producto">
                            ...
                            <div class="col-xs-6 col-sm-3">
                                ...
                                <div class="col-xs-6 col-sm-3" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                    <div class="price {% if not product.display_price %}hidden{% endif %}">
                                        {% if product.compare_at_price %}
                                            <h3 class="precio_oferta" id="compare_price_display">{{ product.compare_at_price | money }}</h3>
                                        {% endif %}
                                        {% if product.display_price %}
                                            <h3 class="price" id="price_display" itemprop="price">{{ product.price | money }}</h3>
                                        {% endif %}
