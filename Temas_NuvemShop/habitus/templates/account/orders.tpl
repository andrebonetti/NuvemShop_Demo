<div class="page-account container page">
    ...
    <div class="container-fluid">
        <div class="customer-box col-md-12 col-sm-12 col-xs-12">
        ...
        <div id="orderBoxDesk" class="order-box col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="wrapper">
            ...
            <div class="row no-gutter last">
                <a class="checkout-link btn btn-primary btn-lg" href="{{ order.checkout_url | add_param('ref', 'orders_list') }}" target="_blank">{{'Realizar el pago >' | translate}}</a>
            </div>
        </div>
        {% endfor %}
    </div>
