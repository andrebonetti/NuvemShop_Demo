    ...
    <div class="contentBox productContainer">
        ...
        <div class="data">
            ...
            <div class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                <span id="price_display" itemprop="price" {% if not product.display_price %}class="hidden"{% endif %}>{{ product.price | money_long }}</span>
        ...
        <div id="related" class="cf">
            ...
            {% else %}
                ...
                {% for related in category.products | shuffle | take(4) %}
                            ...
                            <strong>{{ related.name }}</strong>
                                {% if related.display_price %}
                                    ...
                                    <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                        <meta itemprop="price" content="{{ related.price | money }}" />
                                    </div>
                                {% endif %}
                            </span>
                        </a>
