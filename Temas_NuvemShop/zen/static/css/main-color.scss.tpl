...
#newsletter input:hover.btn {
    background: rgba($secondary, $opac6)
}

#wrapper-foot a.soc-foot, .span6.contact-social i.fa {
    background-color: rgba($secondary, $opac2)
}

#wrapper-foot a.soc-foot i.fa, .span6.contact-social i.fa {
    color: $secondary;
}
...
#shoppingCartPage .cart-contents .productrow .col-quantity input, #shipping-zipcode, #newsletter input[type="news"], #newsletter input[type="text"], #shop_bar .attributeLine select, .productContainer .descriptioncol .attributeLine select, .productContainer .descriptioncol .attributeLineQuickshop select, .productContainer .descriptioncol .attributeLineQuickshop input {
    font-family: $fonthead;
    border: 1px solid;
