...
/* TWITTER 100% */
iframe[id^='twitter-widget-']{ width:100% !important; margin:0 0 0px 0;}
...
.footer{
		...
		.copy{padding:12px 0 10px 0; background-color:{{ settings.footer_background_color }}; color:{{ settings.navigation_foreground_color }}; 
			...
			.copyright{text-align:right; font-size:12px; color:{{ settings.navigation_foreground_color }}; font-weight:700;}
			 }
		/* FOOTER 1*/
		.footer1{
			background-color:lighten({{ settings.footer_background_color }}, 10%); color:{{ settings.navigation_foreground_color }};
			padding:20px 0 10px 0;
			h1{font-size:16px; padding:0px 0 10px 0; text-transform: uppercase;}
			 .followus {
	    ...
	    .footer2{background-color:lighten({{ settings.footer_background_color }}, 10%); color:{{ settings.navigation_foreground_color }}; padding-bottom:31px; padding-top: 10px;
		    	h1{text-transform:uppercase; font-size:16px; padding:0 0 10px 0; }
		    	.menu{
...
/* PRODUCT DETAIL */
#shipping-calculator .calculatorButton{background-color:darken({{ settings.main_brand_color }},20%);color:{{ settings.navigation_foreground_color }}; text-align:center;border: 2px solid darken({{ settings.main_brand_color }},15%);}
#shipping-calculator .calculatorButton:hover{background-color:darken({{ settings.main_brand_color }},16%);}
...
.prod_detail{
		    ...
		    .addtocart{padding:5px 0 20px 0; margin:0px 0 10px 0; float:right; border-bottom:solid 1px tint($main_foreground_color, 80%);
...
.searchbox{
		   ...
		   input{font-size:12px; padding:10px; height:25px; outline:0; width:220px;}
...
.search-result{
				.no-result{background-color:tint($main_foreground_color,81%); padding:101px; text-align:center; color:$main_foreground_color; text-transform:uppercase; margin:0 0 31px 0;}
...
.pagecontact .form{padding:0 0 51px 0;
				   ...
				   input{width:80%; border:solid 1px tint($main_foreground_color, 30%); padding:10px;}
				   .inputarea{width:80%; border:solid 1px tint($main_foreground_color, 30%); padding:10px;}
...
.prod_detail, .page_detail, .search-result, .page404, .pagecontact{padding-top:196px;}
}
...
.sf-menu li.active > a{
  color: lighten({{settings.main_brand_color}},40%)!important;
}
