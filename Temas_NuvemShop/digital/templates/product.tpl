      ...
      <form id="product_form" method="post" action="{{ store.cart_url }}">
        ...
        {% endif %}
            <div class="product-price-holder" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                ...
                <span class="priceBoxWrapper"><span id="price_display" itemprop="price" class="priceBox {% if not product.display_price %}hidden{% endif %}">{{ product.price | money_long }}</span></span>
