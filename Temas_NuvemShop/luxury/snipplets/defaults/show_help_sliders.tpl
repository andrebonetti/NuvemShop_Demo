                            ...
                            <div class="row-fluid big-row">
                                <div class="center">
                                    <div class="span12">
                                        ...
                                        <a href="{{ help_url }}" class="top">{{ "Cargar ahora mis productos" | translate }}</a>
                        ...
                        <div class="jTscroller">
                            ...
                            <div class="dest-sec show_help">
                                ...
                                <div class="bajada">
                                    ...
                                    <div class="price">
                                        <span class="price" id="price_display" itemprop="price">{{"8000" | money }}</span>
                                        <span class="price-compare">
                ...
                <div id="tS3-coming" class="jThumbnailScroller hidden-phone">
                    <div class="jTscrollerContainer">
                        ...
                        <div class="jTscroller">
                            <div class="dest-sec show_help">
                                <div class="head">
                                    <a href="{{ help_url }}">{{'images/help-product-06-mini.jpg' | static_url | img_tag}}</a>
                                </div>
                                <div class="bajada">
                                    <div class="category">{{ "Camisas" | translate }}</div>
