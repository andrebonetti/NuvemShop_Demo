                ...
                <div class="product-row">
                        ...
                        <div class="row big-row">
                            <div class="container center">
                                <div class="span12">
                                    ...
                                    <a href="/admin/products/new/" class="top">{{ "Cargar ahora mis productos" | translate }}</a>
                    ...
                    <div class="dest-gral">
                        ...
                        <div class="bajada">
                            ...
                            <div class="price">
                                <span class="price" id="price_display" itemprop="price">{{"7200" | money }}</span>
                    ...
                    <div class="dest-gral">
                        ...
                        <div class="bajada">
                            ...
                            <div class="price">
                                <span class="price" id="price_display" itemprop="price">{{"44200" | money }}</span>
                            </div>
                        </div>
                    </div>
                    <!-- Product 03 -->
                    <div class="dest-gral">
                        ...
                        <div class="bajada">
                            ...
                            <div class="price">
                                <span class="price" id="price_display" itemprop="price">{{"10200" | money }}</span>
								<span class="price-compare">
                ...
                <div class="product-row">
                    ...
                    <div class="dest-gral">
                        ...
                        <div class="bajada">
                            ...
                            <div class="price">
                                <span class="price" id="price_display" itemprop="price">{{"11200" | money }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Product 07 -->
                            <div class="dest-gral">
                                ...
                                <div class="bajada">
                                    ...
                                    <div class="price">
                                        <span class="price" id="price_display" itemprop="price">{{"13200" | money }}</span>
